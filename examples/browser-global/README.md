...
const language = await DataTablesAltEditorLite.loadEditorLanguage(
  'https://cdn.jsdelivr.net/npm/datatables-alteditor-lite/dist/locales/ja.json',
);
...
`dist/locales/datatables-alteditor-lite.ja.min.js` can be loaded after the main
