 ...
 */
export type FieldValue<TConfig> = TConfig extends {
  readonly type: 'custom';
  readonly definition: import('./custom-field.js').CustomFieldRuntimeDefinition<
    infer TValue,
    object | undefined
  >;
}
  ? TValue
  : TConfig extends { readonly type: 'number' }
